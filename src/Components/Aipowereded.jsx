...
const Aipowereded = () => {
    return (
        ...
        <div className=' 576:pt-[60px] md:pt-[80px] 992:pt-[140px] relative 576:pb-[60px] md:pb-[120px] 992:pb-[192px] bg-[#040606]' id='feature'>
...
<div className=' relative'>
                        <img src={s2img} alt="s2img" className=' max-w-[612px] w-full relative z-[0] me-auto mix-blend-exclusion' />
                    ...
                    <div className=' w-full md:w-1/2 px-3 pt-[20px] md:pt-0'>
                        <div className=' max-w-[517px] mx-auto'>
                            <h2 className=' md:max-w-[517px] Recharge font-bold text-[#02CDCF] text-[25px] 576:text-[30px] 992:text-[40px] leading-[normal] 576:leading-[35.4px] 992:leading-[50.4px] text-center md:text-start' data-aos="zoom-in-up">Ai-Powered Home Assistant</h2>
