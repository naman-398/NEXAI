      ...
      <div className=' max-w-[1164px] px-3 mx-auto'>
        <div className=' flex flex-wrap flex-row -mx-3 justify-between  sm:mt-[145px] items-center'>
          <div className=' w-full sm:w-1/2 md:w-1/3 px-3 '>
            ...
            <p className='Recharge font-bold text-[14px] 576:text-[16px] leading-[normal] 576:leading-[25.6px] max-w-[356px] text-[#FFFFFF]' data-aos="zoom-in-up">Nullam viverra natoque amet et sed scelerisque viverra fringilla platea. Ullamcorper.</p>
            ...
            <div className=' flex-wrap flex flex-row -mx-3'>
              <div className=' w-1/2 px-3  flex flex-col sm:items-center'>
                <ul className=' flex flex-col gap-[5px] 576:gap-[15px] md:gap-[20px]'>
                  ...
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">Home</a></li>
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">Features</a></li>
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">Marketplace</a></li>
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">Tokens</a></li>
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">NexChat</a></li>
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">About</a></li>
                </ul>
              </div>
              <div className=' w-1/2 px-3 flex flex-col sm:items-end'>
                <ul className=' flex flex-col gap-[5px]  576:gap-[15px] md:gap-[20px]'>
                  ...
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">Contact</a></li>
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">Phone</a></li>
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">terms</a></li>
                  <li data-aos="zoom-in-up"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]' data-aos="zoom-in-up">Privacy</a></li>
                </ul>
              </div>
            </div>
          </div>
