            ...
            <div className=' flex-wrap flex flex-row -mx-3'>
              <div className=' w-1/2 px-3  flex flex-col sm:items-center'>
                <ul className=' flex flex-col gap-[5px] 576:gap-[15px] md:gap-[20px]'>
                  <li data-aos="zoom-in-down"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px]' data-aos="zoom-in-up">Quick links</a></li>
                  <li data-aos="zoom-in-down"><a href="#home" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] !opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]'>Home</a></li>
                  <li data-aos="zoom-in-down"><a href="#feature" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] !opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]'>Features</a></li>
                  <li data-aos="zoom-in-down"><a href="#market" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] !opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]'>Marketplace</a></li>
                  <li data-aos="zoom-in-down"><a href="#token" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] !opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]'>Tokens</a></li>
                  <li data-aos="zoom-in-down"><a href="#what" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] !opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]'>NexChat</a></li>
                  <li data-aos="zoom-in-down"><a href="#about" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] !opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]'>About</a></li>
                </ul>
              </div>
              <div className=' w-1/2 px-3 flex flex-col sm:items-end'>
                <ul className=' flex flex-col gap-[5px]  576:gap-[15px] md:gap-[20px]'>
                  <li data-aos="zoom-in-down"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px]' data-aos="zoom-in-up">Information's</a></li>
                  <li data-aos="zoom-in-down"><a href="mailto:namanjyani95200@gmail.com" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] !opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]'>Contact</a></li>
                  <li data-aos="zoom-in-down"><a href="tel:+917404215521" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] !opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]'>Phone</a></li>
                  <li data-aos="zoom-in-down"><a href="" className=' Recharge text-[#FFF] text-[14px] 576:text-[18px] font-bold leading-[21.6px] !opacity-70  after:absolute relative after:w-0 after:left-[50%] after:bottom-[-1px] hover:text-[#02CDCF] duration-300 after:bg-[#02CDCF] hover:after:w-full hover:after:left-0 after:duration-300 after:h-[2px] after:rounded-[20px]'>terms</a></li>
