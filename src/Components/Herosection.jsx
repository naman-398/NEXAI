...
const Herosection = () => {
    return (
        <div className=' pt-[10px] pb-[55px] overflow-hidden bg-[#050505]' >
            <div className=' bg-[url(../src/Assets/Images/herobg.webp)] min-h-[100vh] bg-no-repeat bg-cover md:bg-100% bg-right md:bg-center mx-auto'>
                <Pagenav />
                <div id='home' className=' max-w-[1164px] mx-auto px-3 1200:py-0 min-h-[80vh] md:block  flex justify-center flex-col md:!pt-[104px] 1440:!pt-[170px]'>
