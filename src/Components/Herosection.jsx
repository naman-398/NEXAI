...
const Herosection = () => {
    return (
        ...
        <div className=' bg-[url(../src/Assets/Images/herobg.webp)] 1200:min-h-[800px] bg-no-repeat bg-cover md:bg-100% bg-right md:bg-center mx-auto'>
            <Pagenav />
            <div className=' max-w-[1164px] mx-auto px-3 1200:py-0 py-[200px]  1200:pt-[104px]'>
